...
test('line chart parameters work', function () {
    ...
    expect((_k = (x.xAxis).title) === null || _k === void 0 ? void 0 : _k.text).toEqual('test');
    expect((_l = (x.yAxis).labels) === null || _l === void 0 ? void 0 : _l.format).toEqual('{value}');
});
test('bar chart parameters work', function () {
    ...
    expect((_j = x.legend) === null || _j === void 0 ? void 0 : _j.enabled).toEqual(false);
    expect((_k = (x.xAxis).title) === null || _k === void 0 ? void 0 : _k.text).toEqual('test');
    expect((_l = (x.yAxis).labels) === null || _l === void 0 ? void 0 : _l.format).toEqual('{value} unit');
});
